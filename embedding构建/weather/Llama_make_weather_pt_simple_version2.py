...
'''python /root/autotimes/embedding构建/weather/Llama_make_weather_pt_simple_version2.py \
  ...
  --out_weather_pt /root/autodl-tmp/datasets/SelfMadeAusgridData/weather/0331_llama_fullstation_date_simple_temperature_and_token_token96.pt \
  --token_len 96 \
  --batch_size 8 \
  --max_length 192 \
  --device cuda \
