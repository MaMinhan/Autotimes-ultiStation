...
if __name__ == "__main__":
    main()
'''python /root/autotimes/embedding构建/weather/make_weather_pt_from_hourly_temperature_csv_eos_by_token_len.py \
  --power_csv /root/autodl-tmp/datasets/SelfMadeAusgridData/electricity/merged_include_id_filled.csv \
  --weather_csv /root/autodl-tmp/datasets/SelfMadeAusgridData/weather/第二次生成的2021-2024weather数据/weather_hourly_20210501_20240430.csv \
  --llm_ckp_dir /root/autodl-tmp/hf_models/gpt2 \
  --out_weather_pt /root/autodl-tmp/datasets/SelfMadeAusgridData/weather/weather_token96_gpt2_eos.pt \
  --token_len 96 \
  --batch_size 64 \
  --max_length 192 \
  --device cuda \
