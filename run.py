...
if __name__ == '__main__':
    ...
    parser.add_argument('--time_pt_path', type=str, default='/root/autodl-tmp/datasets/electricity_pt/time_only_20260129.pt')
    ...
    parser.add_argument('--llm_ckp_dir', type=str, default='/root/autodl-tmp/hf_models/gpt2', help='llm checkpoints dir')
